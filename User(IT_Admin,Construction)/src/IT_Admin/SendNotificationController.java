...
public class SendNotificationController implements Initializable {
    ...
    @FXML
    private void getConfirmationMessage(ActionEvent event) {
        ...
        if(result.get() == ButtonType.OK){
            ...
            showCustomInformationAlert("Message Sent!");
        }
        else{
            //show appropriate cancellation message
            showCustomInformationAlert("Notification Sent Cancelled"); 
        }
    ...
    @FXML
    private void goToNavigationMenu(ActionEvent event) throws IOException {
